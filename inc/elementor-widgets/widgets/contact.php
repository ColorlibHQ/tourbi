...
/**
 *
 * tourbi elementor about page section widget.
 *
 * @since 1.0
 */
class Tourbi_Contact extends Widget_Base {

    public function get_name() {
        return 'tourbi-contact';
    }

    public function get_title() {
        return __( 'Contact', 'tourbi' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'tourbi' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'tourbi' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'tourbi' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'tourbi' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'tourbi' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'tourbi' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => tourbi_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'tourbi' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'tourbi' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'tourbi')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'tourbi' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'tourbi' ),
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Right Text Title Color', 'tourbi' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Right Text Sub Title Color', 'tourbi' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
