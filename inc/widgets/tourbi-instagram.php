...
----------------------------------------*/
class tourbi_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('tourbi_instagram_photo',esc_html__('[ Tourbi ] Intagram Photo','tourbi'),array(
			'description' => esc_html__('Tourbi Instagram Photo Widget','tourbi'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'tourbi');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'tourbi'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'tourbi'); ?></label>
...
if(!function_exists('tourbi_instagram_widgets')):
	function tourbi_instagram_widgets(){
		register_widget('tourbi_instagram_photo');
	}
	add_action('widgets_init','tourbi_instagram_widgets');
endif;
