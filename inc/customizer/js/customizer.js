(function( $ , api){
    ...
    api.section( 'tourbi_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'tourbi_about_section' , function( section ){
    ...
    api.section( 'tourbi_blog_section' , function( section ){
    ...
    api.section( 'tourbi_portfolio_section' , function( section ){
    ...
    api.section( 'tourbi_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-tourbi_contact_custom_formshortcode'),
                selector = $('#_customize-input-tourbi_contact_formshortcode');
    ...
    // General section
    api.section( 'tourbi_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#tourbi_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-tourbi_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-tourbi_preloader_color' );
            ...
            var $backtotop          = $( '#tourbi_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-tourbi_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-tourbi_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'tourbi_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#tourbi_footer_widget_toggle');
