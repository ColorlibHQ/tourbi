...
// image default alt
if( !function_exists( 'tourbi_img_default_alt' ) ){
	function tourbi_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'tourbi_img_tag' ) ){
	function tourbi_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = tourbi_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'tourbi_anchor_tag' ) ){
	function tourbi_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'tourbi_heading_tag' ) ){
	function tourbi_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'tourbi_paragraph_tag' ) ){
	function tourbi_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'tourbi_other_tag' ) ){
	function tourbi_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'tourbi_button_element ' ) ){
	function tourbi_button_element( array $args ){
